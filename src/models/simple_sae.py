...
class SAE(nn.Module):
    def __init__(self, input_dim, latent_space_dim, encoder_dims=[1000], decoder_dims=None):
        super().__init__()
        ...
        # decoder_layers.append(nn.Sigmoid())          # adjust this based on the embedding range
